				...
				<div class="panel card-sign">
					<div class="card-body">
						<div class="current-user text-center">
							<img src="{{asset('owner/img/ll.jpg')}}" class="rounded-circle user-image" />
							<a href="{{route('login_default')}}" class="user-name text-dark m-0">Living Legacy</a>
							<p class="user-email m-0">We are closed now! We will reopen at 10:00 AM (EST)</p>
						</div>
					</div>
				</div>
			</div>
